    ...
    <section className="py-24 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative group">
          {/* Glow effect */}
          <div className="absolute -inset-1 bg-gradient-to-r from-primary/12 via-primary/6 to-primary/12 blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-500" />
            ...
            >
              ...
              {isTyping && (
                <div className="mb-1 text-foreground">
                  ...
                  <span className="inline-block w-2 h-4 bg-primary terminal-cursor ml-0.5" />
                </div>
              )}
